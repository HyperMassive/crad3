...
const PrototypeThree = ({ classes }) => (
  <div>
    <Typography variant="display3">Prototype Three</Typography>
    <Typography variant="subheading">D3 Black box v6</Typography>
    <Typography variant="body1">
      Adding redux in order to resemble a typical react/ redux app. Also added a
      over simplified method to deliver new data to d3, however it does not play
      nice with d3's data-merges, hence the loss of state.
      <br />
      <br />
